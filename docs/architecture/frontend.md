...
| 프레임워크 (모바일) | **Expo SDK 56+ Dev Client** (React Native + Expo Router) | Expo Go 미사용, `apps/mobile` 구조 스캐폴드 존재(비활성, Sprint M-1 활성화) — ADR-041/043 |
...
2. WSL ext4 미러에서 `npm install` + `expo install --check`로 Expo SDK 56 호환 버전 정합
