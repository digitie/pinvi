...
| `PINVI_PROMETHEUS_PORT` | `12601` |
| `PINVI_CADVISOR_PORT` | `12602` |
| `PINVI_GRAFANA_PORT` | `12605` |
| `NEXT_PUBLIC_PINVI_API_URL` | `http://127.0.0.1:12501` |
...
| Prometheus | `http://127.0.0.1:12601` |
| Grafana | `http://127.0.0.1:12605` |
