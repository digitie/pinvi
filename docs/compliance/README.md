...
| [legal-ops-implementation-prep-gate.md](../execplan/legal-ops-implementation-prep-gate.md) | Sprint 6 legal/ops 구현 표면·상태·증거·테스트 gate           |
...
- [ ] T-258 legal/ops 구현 매트릭스 최신성 재확인 — incident 72시간 신고, DSR 10일,
      mobile/AI 제외 gate
