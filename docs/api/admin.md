...
```jsonc
{
  "data": {
    "datasets": [
      ...
      { "schema": "feature", "table_name": "features", "owner": "kor-travel-map", "row_count": 12345 },
      { "schema": "feature", "table_name": "source_records", "owner": "kor-travel-map", "row_count": 67890 },
      { "schema": "provider_sync", "table_name": "state", "owner": "kor-travel-map", "row_count": 12 }
    ]
  }
}
```
...
kor-travel-map dedup verdict는 kor-travel-map admin OpenAPI로 callback한다.
