...
| Sprint 5 | [SPRINT-5.md](./SPRINT-5.md) | in progress (Admin/ETL/Grafana/System 일부 post-v0.1.0 반영) | 실시간 WebSocket + Dagster ETL + Loki + Grafana embed + **Backup/Restore 1차** | **`v0.2.0`** |
