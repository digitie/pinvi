...
ADR 현황: ADR-001 ~ **ADR-031**. 최근 박힘: ADR-024 (NTFS worktree=git source of
...
규약 정본 + `/v1` 노출), ADR-031 (POI soft delete + `feature_id` nullable). 다음 신규
= ADR-032. 2026-06-06 정합성 감사: `docs/audit/2026-06-06-doc-impl-audit.md`.
