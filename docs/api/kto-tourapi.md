...
- 최신 확인 내용: `6fd0601a..dc855cb1` 구간에서 TripMate가 요청했던 호출 provenance, typed related-tour model, pagination helper, exception metadata, 저작권/HTML 표시 helper가 pykrtourapi public API로 추가됐다.
...
from pykrtourapi import ContentType, Wgs84Coordinate, clean_tourapi_html, copyright_display_info
