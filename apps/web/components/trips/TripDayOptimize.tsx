        ...
        <div className="space-y-2 rounded-sm border border-hairline bg-surface-soft p-3 text-sm">
          ...
          <div className="flex justify-end gap-2">
            <button
              ...
              className="h-8 rounded-sm border border-hairline px-3 text-xs font-semibold text-ink hover:bg-canvas"
            >
              닫기
            </button>
            <button
              ...
              className="inline-flex h-8 items-center gap-1 rounded-sm bg-cta px-3 text-xs font-semibold text-on-primary hover:bg-cta-hover disabled:opacity-50"
            >
