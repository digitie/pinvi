    ...
    >
      ...
      <div className="flex items-end gap-2">
        ...
        <button
          ...
          className="inline-flex h-9 shrink-0 items-center gap-1 rounded-sm bg-cta px-3 text-sm font-semibold text-on-primary hover:bg-cta-hover disabled:opacity-50"
        >
          {posting ? (
