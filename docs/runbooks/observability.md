...
|--------|----------:|---------------:|-----|
| Prometheus | `12601` | `9090` | `http://127.0.0.1:12601` |
| cAdvisor Exporter | `12602` | `8080` | `http://127.0.0.1:12602` |
| Grafana | `12605` | `3000` | `http://127.0.0.1:12605` |
...
- `prometheus:9090`
- `cadvisor:8080`
- `host.docker.internal:12501/metrics` (WSL dev FastAPI)
...
`http://localhost:12605/d/pinvi/overview?orgId=1&kiosk=tv`다.

## 5. 검증

```bash
curl -fsS http://127.0.0.1:12501/metrics | grep pinvi_api_http_requests_total
curl -fsS http://127.0.0.1:12601/-/ready
curl -fsS http://127.0.0.1:12605/api/health
```
