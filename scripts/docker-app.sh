...
API_PORT="${TRIPMATE_API_PORT:-12501}"
WEB_PORT="${TRIPMATE_WEB_PORT:-12505}"
RUSTFS_PORT="${TRIPMATE_RUSTFS_PORT:-12101}"
RUSTFS_CONSOLE_PORT="${TRIPMATE_RUSTFS_CONSOLE_PORT:-12105}"
SMOKE_KEEP_RUNNING=""
