...
Admin live 200/2000, restore staging drill은 이미 통과했고, 남은 항목은 Admin live full catalog
N150 Docker runner 실행, `CHANGELOG.md` release 전환, `v0.2.0` tag/GitHub Release 생성, T-259 문서
마감이다.

**다음 한 작업**: N150 Docker runner로 Admin live full catalog를 실행하고 결과를 release gate 문서에
기록한다.
