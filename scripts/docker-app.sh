...
PROJECT="${TRIPMATE_DOCKER_PROJECT:-tripmate-app}"
COMPOSE_FILE="${TRIPMATE_DOCKER_COMPOSE_FILE:-infra/docker-compose.app.yml}"

API_PORT="${TRIPMATE_API_PORT:-9021}"
WEB_PORT="${TRIPMATE_WEB_PORT:-9022}"
RUSTFS_PORT="${TRIPMATE_RUSTFS_PORT:-9003}"
RUSTFS_CONSOLE_PORT="${TRIPMATE_RUSTFS_CONSOLE_PORT:-9004}"
SMOKE_KEEP_RUNNING=""
...
Defaults:
  API URL:            http://127.0.0.1:9021
  Web URL:            http://127.0.0.1:9022
  RustFS API URL:     http://127.0.0.1:9003
  RustFS console URL: http://127.0.0.1:9004

Environment overrides:
  TRIPMATE_DOCKER_PROJECT=tripmate-app
  TRIPMATE_DOCKER_COMPOSE_FILE=infra/docker-compose.app.yml
